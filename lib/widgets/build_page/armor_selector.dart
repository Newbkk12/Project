...
/// ArmorSelector - Widget for selecting and configuring armor
///
/// This widget provides:
/// - Dropdown for selecting armor from available items
/// - Enhancement level slider (0-16)
/// - Two crystal slots with dropdowns
/// - Display of armor stats with enhancement bonuses
class ArmorSelector extends StatelessWidget {
  ...
  Widget _buildDropdown({
    ...
    final items = EquipmentData.itemsByType(EquipmentType.armor);
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(
                    selectedItem?.name ?? 'Choose armor...',
                    style: TextStyle(
                      fontSize: 12,
